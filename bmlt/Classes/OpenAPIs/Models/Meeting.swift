...
public struct Meeting: Codable, JSONEncodable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(temporarilyVirtual, forKey: .temporarilyVirtual)
